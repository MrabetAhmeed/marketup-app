      ...
      <div className="max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-on-surface-variant">
              <li><a href="/mentions-legales" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Mentions l&eacute;gales</a></li>
              <li>
                <a href="/cgu" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">CGU</a>
                {" - "}
                <a href="/cgv" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">CGV</a>
              </li>
              <li><a href="/confidentialite" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Confidentialit&eacute;</a></li>
