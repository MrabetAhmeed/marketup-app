              ...
              <div className="p-4 bg-[#F5F5F5] border border-[#E0E0E0] rounded-lg">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#242424] leading-snug">
                    J&apos;accepte les{" "}
                    <a href="/cgu" target="_blank" rel="noopener noreferrer" className="text-[#0078D4] font-semibold hover:underline">Conditions Générales d&apos;Utilisation (CGU)</a>{" "}
                    et les{" "}
                    <a href="/cgv" target="_blank" rel="noopener noreferrer" className="text-[#0078D4] font-semibold hover:underline">Conditions Générales de Vente (CGV)</a>{" "}
