...
export default async function BillingPage(): Promise<JSX.Element> {
  ...
  return (
    <div className="max-w-[800px] mx-auto py-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="font-heading font-bold text-[22px] text-ink-primary">Facturation</h1>
        <p className="text-[13px] text-ink-secondary mt-1">Historique de vos transactions et factures</p>
      </div>
