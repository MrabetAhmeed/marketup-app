export function companyResubmittedEmailTemplate(params: {
  ...
  return {
    subject: `Re-soumission compte : ${params.companyName} — vivasky.media`,
    html: `<!DOCTYPE html>
<html lang="fr">
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" style="max-width:480px;background:#FFFFFF;border-radius:8px;border:1px solid #E0E0E0;padding:40px 32px;">
        <tr><td>
          ...
          <p style="margin:24px 0 0;font-size:12px;color:#A0A0A0;">Cet email est envoyé automatiquement par vivasky.media.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
