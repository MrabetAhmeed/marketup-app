...
function buildCompanies(): CompanySeedData[] {
  return [
    ...
    // c-002 — MediaCom Communication
    {
      ...
      pendingUpdates: { submittedAt: daysAgo(2), fields: [{ key: "liveData.gouvernorat", label: "Gouvernorat", currentValue: "tunis", newValue: "ariana" }], note: "Ouverture d'une agence à Ariana — changement du gouvernorat de rattachement." },
      profiles: {
