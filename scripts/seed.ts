...
function buildCompanies(): CompanySeedData[] {
  return [
    // c-001 — TechnoFab Industries (canonical demo company)
    {
      ...
      transactions: [
        { seedId: "t-c-001-1", type: "sponsoring", refSeedId: "s-c-001-1", profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(2), paymentMethod: "card", paymentReference: "MP-SPO-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00042", createdAt: daysAgo(2) },
        { seedId: "t-c-001-2", type: "boost", refSeedId: "b-c-001-1", profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(15), paymentMethod: "card", paymentReference: "MP-BST-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00031", createdAt: daysAgo(15) },
        { seedId: "t-c-001-3", type: "sponsoring", refSeedId: null, profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(45), paymentMethod: "bank_transfer", paymentReference: "BT-SPO-002", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00024", createdAt: daysAgo(45) },
        { seedId: "t-c-001-4", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(52), paymentMethod: "card", paymentReference: "MP-BST-002", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00019", createdAt: daysAgo(52) },
        { seedId: "t-c-001-5", type: "sponsoring", refSeedId: null, profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(59), paymentMethod: "card", paymentReference: "MP-SPO-003", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00015", createdAt: daysAgo(59) },
        { seedId: "t-c-001-6", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(63), paymentMethod: "card", paymentReference: "MP-BST-003", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00012", createdAt: daysAgo(63) },
        { seedId: "t-c-001-7", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(69), paymentMethod: "card", paymentReference: "MP-BST-004", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00008", createdAt: daysAgo(69) },
        { seedId: "t-c-001-8", type: "sponsoring", refSeedId: null, profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(73), paymentMethod: "card", paymentReference: "MP-SPO-004", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00005", createdAt: daysAgo(73) },
        { seedId: "t-c-001-9", type: "boost", refSeedId: "b-c-001-0", profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(71), paymentMethod: "card", paymentReference: "MP-BST-005", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00006", createdAt: daysAgo(71) },
        { seedId: "t-c-001-10", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(77), paymentMethod: "manual", paymentReference: "MAN-BST-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00003", createdAt: daysAgo(77) },
        { seedId: "t-c-001-11", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(84), paymentMethod: "card", paymentReference: "MP-BST-006", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00001", createdAt: daysAgo(84) },
        { seedId: "t-c-001-12", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(90), paymentMethod: "card", paymentReference: "MP-BST-007", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00000", createdAt: daysAgo(90) },
      ],
      rseReceipts: [
    ...
    // c-003 — GreenLife Bio
    {
      ...
      transactions: [
        { seedId: "t-c-003-1", type: "boost", refSeedId: "b-c-003-1", profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(21), paymentMethod: "card", paymentReference: "MP-BST-GL-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00036", createdAt: daysAgo(21) },
      ],
    ...
    // c-005 — FoodCorner Restaurant (suspended)
    {
      ...
      transactions: [
        { seedId: "t-c-005-1", type: "boost", refSeedId: null, profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(71), paymentMethod: "card", paymentReference: "MP-BST-FC-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00011", createdAt: daysAgo(71) },
        { seedId: "t-c-005-2", type: "boost", refSeedId: null, profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "refunded", paidAt: daysAgo(38), paymentMethod: "card", paymentReference: "MP-BST-FC-002", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00027", createdAt: daysAgo(38) },
      ],
      rseReceipts: [],
    },
    ...
    // c-007 — AutoPlus
    {
      ...
      transactions: [
        { seedId: "t-c-007-1", type: "boost", refSeedId: "b-c-007-0", profileKind: "traceup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(66), paymentMethod: "card", paymentReference: "MP-BST-AP-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00014", createdAt: daysAgo(66) },
      ],
      rseReceipts: [],
    },
    ...
    // c-009 — EduPro Formation
    {
      ...
      transactions: [
        { seedId: "t-c-009-1", type: "boost", refSeedId: "b-c-009-1", profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(10), paymentMethod: "card", paymentReference: "MP-BST-EP-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00044", createdAt: daysAgo(10) },
        { seedId: "t-c-009-2", type: "sponsoring", refSeedId: "s-c-009-1", profileKind: "brandup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(5), paymentMethod: "card", paymentReference: "MP-SPO-EP-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00046", createdAt: daysAgo(5) },
      ],
    ...
    // c-010 — TextilTunis
    {
      ...
      transactions: [
        { seedId: "t-c-010-1", type: "boost", refSeedId: "b-c-010-0", profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(50), paymentMethod: "card", paymentReference: "MP-BST-TT-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "2026-00020", createdAt: daysAgo(50) },
      ],
      rseReceipts: [],
    },
