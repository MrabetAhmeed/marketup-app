...
function buildCompanies(): CompanySeedData[] {
  return [
    // c-001 — TechnoFab Industries (canonical demo company)
    {
      ...
      liveData: { contactEmail: "contact@technofab.tn", phone: "+216 73 222 333", whatsapp: "+216 20 123 456", address: "Rue de l'Industrie, ZI Sahline", gouvernorat: "sousse", ville: "Sahline", sectorId: "mecanique", languages: ["fr"] },
      ...
      transactions: [
        { seedId: "t-c-001-1", type: "sponsoring", refSeedId: "s-c-001-1", profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(2), paymentMethod: "card", paymentReference: "MP-SPO-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0042", createdAt: daysAgo(2) },
        { seedId: "t-c-001-2", type: "boost", refSeedId: "b-c-001-1", profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(15), paymentMethod: "card", paymentReference: "MP-BST-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0031", createdAt: daysAgo(15) },
        { seedId: "t-c-001-3", type: "sponsoring", refSeedId: null, profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(45), paymentMethod: "bank_transfer", paymentReference: "BT-SPO-002", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0024", createdAt: daysAgo(45) },
        { seedId: "t-c-001-4", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(52), paymentMethod: "card", paymentReference: "MP-BST-002", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0019", createdAt: daysAgo(52) },
        { seedId: "t-c-001-5", type: "sponsoring", refSeedId: null, profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(59), paymentMethod: "card", paymentReference: "MP-SPO-003", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0015", createdAt: daysAgo(59) },
        { seedId: "t-c-001-6", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(63), paymentMethod: "card", paymentReference: "MP-BST-003", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0012", createdAt: daysAgo(63) },
        { seedId: "t-c-001-7", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(69), paymentMethod: "card", paymentReference: "MP-BST-004", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0008", createdAt: daysAgo(69) },
        { seedId: "t-c-001-8", type: "sponsoring", refSeedId: null, profileKind: "linkup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(73), paymentMethod: "card", paymentReference: "MP-SPO-004", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0005", createdAt: daysAgo(73) },
        { seedId: "t-c-001-9", type: "boost", refSeedId: "b-c-001-0", profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(71), paymentMethod: "card", paymentReference: "MP-BST-005", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0006", createdAt: daysAgo(71) },
        { seedId: "t-c-001-10", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(77), paymentMethod: "manual", paymentReference: "MAN-BST-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0003", createdAt: daysAgo(77) },
        { seedId: "t-c-001-11", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(84), paymentMethod: "card", paymentReference: "MP-BST-006", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0001", createdAt: daysAgo(84) },
        { seedId: "t-c-001-12", type: "boost", refSeedId: null, profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(90), paymentMethod: "card", paymentReference: "MP-BST-007", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0000", createdAt: daysAgo(90) },
      ],
      rseReceipts: [
    ...
    // c-002 — MediaCom Communication
    {
      ...
      liveData: { contactEmail: "contact@mediacom.tn", phone: "+216 71 555 200", whatsapp: "+216 20 555 200", address: "Avenue Habib Bourguiba, Tunis Centre", gouvernorat: "tunis", ville: "Tunis", sectorId: "marketing", languages: ["fr"] },
      ...
      pendingUpdates: { submittedAt: daysAgo(2), fields: [{ key: "phone", label: "Téléphone", currentValue: "+216 71 555 100", newValue: "+216 71 555 200" }, { key: "address", label: "Adresse", currentValue: "Rue Mohamed V, Tunis", newValue: "Avenue Habib Bourguiba, Tunis-Centre" }], note: "Déménagement du siège — nouveaux locaux et nouvelle ligne directe." },
      profiles: {
        brandup: { kind: "brandup", status: "active", data: { pitch: i18n("Agence de communication 360° basée à Tunis. Nous accompagnons PME et grands comptes dans leur stratégie de marque, leur identité visuelle et leur déploiement digital."), about: i18n("MediaCom est une agence de communication et de stratégie de marque fondée en 2015 à Tunis."), color: "#6366F1", links: [{ label: i18n("Site web"), url: "https://mediacom.tn", icon: "language" }], gallery: [], projects: [{ id: "proj-c-002-1", name: i18n("Rebranding BIAT 2025"), image: "https://picsum.photos/seed/c-002-proj-1/600/400", description: i18n("Refonte complète de l'identité visuelle de la BIAT."), order: 1 }], certifications: [{ id: "cert-c-002-1", name: "Google Partner Premier", label: i18n("Certification Google Ads"), icon: "verified", image: "https://picsum.photos/seed/c-002-cert-google/200/200", issuedAt: new Date("2025-01-15"), expiresAt: new Date("2026-01-15") }], services: [{ name: i18n("Identité visuelle & branding") }, { name: i18n("Stratégie de communication") }] }, publishedAt: daysAgo(67), lastValidatedAt: daysAgo(67), stats: { viewsTotal: 432, views30d: 87, clicksTotal: 28 }, boosts: [], sponsorings: [] },
        traceup: { kind: "traceup", status: "active", data: { channelName: i18n("MediaCom Studio"), channelDescription: i18n(""), videos: [{ id: "v-c-002-1", source: "youtube", videoId: "kJQP7kiw5Fk", videoUrl: "https://www.youtube.com/watch?v=kJQP7kiw5Fk", thumbnailUrl: ytThumb("kJQP7kiw5Fk"), category: "actualite", title: i18n("Rebranding BIAT — making of"), description: i18n("Coulisses du rebranding."), status: "active", publishedAt: daysAgo(52), order: 1 }] }, publishedAt: daysAgo(67), lastValidatedAt: daysAgo(67), stats: { viewsTotal: 892, views30d: 156, clicksTotal: 42 }, boosts: [], sponsorings: [] },
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Leila Karoui"), fullName: "Leila Karoui", title: i18n("Directrice Associée"), company: i18n("MediaCom Communication"), bio: i18n("15 ans d'expérience en communication."), email: "leila@mediacom.tn", phone: "+216 71 555 100", whatsapp: "+216 71 555 100", website: "https://mediacom.tn", address: "Avenue Habib Bourguiba, Tunis Centre", gpsPosition: { type: "Point", coordinates: [10.1815, 36.8065] } }, qrConfig: { style: "rounded", colorForeground: "#000000", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "linkedin", url: "https://linkedin.com/in/leilakaroui" }, { platform: "facebook", url: "https://facebook.com/mediacom.tn" }] }, publishedAt: daysAgo(67), lastValidatedAt: daysAgo(67), stats: { viewsTotal: 178, views30d: 32, clicksTotal: 15 }, boosts: [], sponsorings: [] },
      },
      transactions: [],
    ...
    // c-003 — GreenLife Bio
    {
      ...
      liveData: { contactEmail: "hello@greenlife.tn", phone: "+216 73 411 333", whatsapp: "+216 20 411 333", address: "Avenue Mohamed V, Sousse", gouvernorat: "sousse", ville: "Sousse", sectorId: "alimentation", languages: ["fr"] },
      ...
      profiles: {
        ...
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Karim Slim"), fullName: "Karim Slim", title: i18n("Fondateur & Gérant"), company: i18n("GreenLife"), bio: i18n("Passionné par l'alimentation saine et durable."), email: "karim@greenlife.tn", phone: "+216 73 411 222", whatsapp: "+216 73 411 222", website: "https://greenlife.tn", address: "Avenue Mohamed V, Sousse", gpsPosition: { type: "Point", coordinates: [10.6411, 35.8254] } }, qrConfig: { style: "square", colorForeground: "#10B981", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "instagram", url: "https://instagram.com/greenlife.tn" }, { platform: "facebook", url: "https://facebook.com/greenlife.tn" }] }, publishedAt: daysAgo(153), lastValidatedAt: daysAgo(153), stats: { viewsTotal: 245, views30d: 67, clicksTotal: 18 }, boosts: [], sponsorings: [] },
      },
      transactions: [
        { seedId: "t-c-003-1", type: "boost", refSeedId: "b-c-003-1", profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(21), paymentMethod: "card", paymentReference: "MP-BST-GL-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0036", createdAt: daysAgo(21) },
      ],
    ...
    // c-004 — BuildTech Construction
    {
      ...
      liveData: { contactEmail: "contact@buildtech.tn", phone: "+216 71 877 600", whatsapp: "+216 20 877 600", address: "Z.I. Charguia II, Tunis", gouvernorat: "tunis", ville: "Tunis", sectorId: "btp", languages: ["fr"] },
      ...
      pendingUpdates: { submittedAt: daysAgo(3), fields: [{ key: "bannerUrl", label: "Bannière", currentValue: bannerUrl("c-004"), newValue: "https://picsum.photos/seed/c-004-banner-v2/1200/400" }] },
      profiles: {
        ...
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Sami Bouazizi"), fullName: "Sami Bouazizi", title: i18n("Directeur Général"), company: i18n("BuildTech Construction"), bio: i18n("20 ans d'expérience BTP en Tunisie."), email: "sami@buildtech.tn", phone: "+216 71 877 555", whatsapp: "+216 71 877 555", website: null, address: "Z.I. Charguia II, Tunis", gpsPosition: { type: "Point", coordinates: [10.2274, 36.8485] } }, qrConfig: { style: "rounded", colorForeground: "#F59E0B", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "linkedin", url: "https://linkedin.com/in/samibouazizi" }] }, publishedAt: daysAgo(33), lastValidatedAt: daysAgo(33), stats: { viewsTotal: 87, views30d: 23, clicksTotal: 6 }, boosts: [], sponsorings: [] },
      },
    ...
    // c-005 — FoodCorner Restaurant (suspended)
    {
      ...
      liveData: { contactEmail: "contact@foodcorner.tn", phone: "+216 74 222 200", whatsapp: "+216 20 222 200", address: "Avenue Hedi Chaker, Sfax", gouvernorat: "sfax", ville: "Sfax", sectorId: "restauration", languages: ["fr"] },
      ...
      profiles: {
        ...
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Mehdi Trabelsi"), fullName: "Mehdi Trabelsi", title: i18n("Chef & Propriétaire"), company: i18n("FoodCorner Restaurant"), bio: i18n("Passionné de cuisine tunisienne depuis 25 ans."), email: "mehdi@foodcorner.tn", phone: "+216 74 222 100", whatsapp: "+216 74 222 100", website: "https://foodcorner.tn", address: "Avenue Hedi Chaker, Sfax", gpsPosition: { type: "Point", coordinates: [10.7603, 34.7406] } }, qrConfig: { style: "rounded", colorForeground: "#EF4444", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "instagram", url: "https://instagram.com/foodcorner.tn" }, { platform: "facebook", url: "https://facebook.com/foodcorner.tn" }] }, publishedAt: daysAgo(204), lastValidatedAt: daysAgo(204), stats: { viewsTotal: 412, views30d: 0, clicksTotal: 67 }, boosts: [], sponsorings: [] },
      },
      transactions: [
        { seedId: "t-c-005-1", type: "boost", refSeedId: null, profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(71), paymentMethod: "card", paymentReference: "MP-BST-FC-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0011", createdAt: daysAgo(71) },
        { seedId: "t-c-005-2", type: "boost", refSeedId: null, profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "refunded", paidAt: daysAgo(38), paymentMethod: "card", paymentReference: "MP-BST-FC-002", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0027", createdAt: daysAgo(38) },
      ],
      rseReceipts: [],
    },
    // c-006 — ArchStudio (pending logo modif)
    {
      ...
      liveData: { contactEmail: "studio@archstudio.tn", phone: "+216 71 333 200", whatsapp: "+216 20 333 200", address: "Rue de Marseille, Tunis", gouvernorat: "tunis", ville: "Tunis", sectorId: "architecture", languages: ["fr"] },
      ...
      pendingUpdates: { submittedAt: daysAgo(7), fields: [{ key: "logoUrl", label: "Logo", currentValue: logoUrl("ArchStudio", "8B5CF6"), newValue: logoUrl("ArchStudioNew", "7C3AED") }] },
      profiles: {
        ...
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Salma Ben Aissa"), fullName: "Salma Ben Aissa", title: i18n("Architecte fondatrice"), company: i18n("ArchStudio"), bio: i18n("Architecte DPLG · Diplômée ENSA Paris-La Villette."), email: "salma@archstudio.tn", phone: "+216 71 333 100", whatsapp: "+216 71 333 100", website: "https://archstudio.tn", address: "Rue de Marseille, Tunis", gpsPosition: { type: "Point", coordinates: [10.1815, 36.8005] } }, qrConfig: { style: "dots", colorForeground: "#8B5CF6", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "linkedin", url: "https://linkedin.com/in/salmabenaissa" }, { platform: "instagram", url: "https://instagram.com/archstudio.tn" }] }, publishedAt: daysAgo(132), lastValidatedAt: daysAgo(132), stats: { viewsTotal: 156, views30d: 38, clicksTotal: 12 }, boosts: [], sponsorings: [] },
      },
      transactions: [],
      rseReceipts: [
    ...
    // c-007 — AutoPlus
    {
      ...
      liveData: { contactEmail: "contact@autoplus.tn", phone: "+216 73 600 200", whatsapp: "+216 20 600 200", address: "Route de Sahline, Sousse", gouvernorat: "sousse", ville: "Sousse", sectorId: "automobile-pro", languages: ["fr"] },
      ...
      profiles: {
        ...
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Omar Belhaj"), fullName: "Omar Belhaj", title: i18n("Directeur Commercial"), company: i18n("AutoPlus"), bio: i18n("15 ans dans la distribution automobile en Tunisie."), email: "omar@autoplus.tn", phone: "+216 73 600 100", whatsapp: "+216 73 600 100", website: "https://autoplus.tn", address: "Route de Sahline, Sousse", gpsPosition: { type: "Point", coordinates: [10.6411, 35.8254] } }, qrConfig: { style: "rounded", colorForeground: "#DC2626", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "linkedin", url: "https://linkedin.com/in/omarbelhaj" }, { platform: "youtube", url: "https://youtube.com/@autoplus.tn" }] }, publishedAt: daysAgo(188), lastValidatedAt: daysAgo(188), stats: { viewsTotal: 234, views30d: 45, clicksTotal: 18 }, boosts: [], sponsorings: [] },
      },
      transactions: [
        { seedId: "t-c-007-1", type: "boost", refSeedId: "b-c-007-0", profileKind: "traceup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(66), paymentMethod: "card", paymentReference: "MP-BST-AP-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0014", createdAt: daysAgo(66) },
      ],
      rseReceipts: [],
    },
    // c-008 — PharmaTN (pending initial registration)
    {
      ...
      liveData: { contactEmail: "contact@pharmatn.tn", phone: "+216 71 999 200", whatsapp: "+216 20 999 200", address: "Avenue de la Liberté, Tunis", gouvernorat: "tunis", ville: "Tunis", sectorId: "sante", languages: ["fr"] },
      ...
      profiles: {
        ...
        traceup: { kind: "traceup", status: "incomplete", data: { channelName: i18n(""), channelDescription: i18n(""), videos: [] }, stats: { viewsTotal: 0, views30d: 0, clicksTotal: 0 }, boosts: [], sponsorings: [] },
        linkup: { kind: "linkup", status: "incomplete", data: { contactCard: { photo: null, fullName: "", title: i18n(""), company: i18n(""), bio: i18n(""), email: "", phone: "", whatsapp: "", website: null, address: "", gpsPosition: null }, qrConfig: { style: "rounded", colorForeground: "#000000", colorBackground: "#FFFFFF", logoOverlay: false }, socials: [] }, stats: { viewsTotal: 0, views30d: 0, clicksTotal: 0 }, boosts: [], sponsorings: [] },
      },
      transactions: [], rseReceipts: [],
    },
    // c-009 — EduPro Formation
    {
      ...
      liveData: { contactEmail: "contact@edupro.tn", phone: "+216 71 444 200", whatsapp: "+216 20 444 200", address: "Avenue Mohamed V, Tunis", gouvernorat: "tunis", ville: "Tunis", sectorId: "formation-pro", languages: ["fr"] },
      ...
      profiles: {
        ...
        linkup: { kind: "linkup", status: "disabled", data: { contactCard: { photo: avatarUrl("Hatem Gharbi"), fullName: "Hatem Gharbi", title: i18n("Directeur pédagogique"), company: i18n("EduPro Formation"), bio: i18n("Expert formation professionnelle."), email: "hatem@edupro.tn", phone: "+216 71 444 100", whatsapp: "+216 71 444 100", website: "https://edupro.tn", address: "Avenue Mohamed V, Tunis", gpsPosition: { type: "Point", coordinates: [10.1815, 36.8065] } }, qrConfig: { style: "rounded", colorForeground: "#7C3AED", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "linkedin", url: "https://linkedin.com/in/hatemgharbi" }] }, publishedAt: daysAgo(245), lastValidatedAt: daysAgo(245), disabledAt: daysAgo(15), stats: { viewsTotal: 89, views30d: 0, clicksTotal: 5 }, boosts: [], sponsorings: [] },
      },
      transactions: [
        { seedId: "t-c-009-1", type: "boost", refSeedId: "b-c-009-1", profileKind: "brandup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(10), paymentMethod: "card", paymentReference: "MP-BST-EP-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0044", createdAt: daysAgo(10) },
        { seedId: "t-c-009-2", type: "sponsoring", refSeedId: "s-c-009-1", profileKind: "brandup", priceHT: 100, vatRate: 0.19, status: "paid", paidAt: daysAgo(5), paymentMethod: "card", paymentReference: "MP-SPO-EP-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0046", createdAt: daysAgo(5) },
      ],
    ...
    // c-010 — TextilTunis
    {
      ...
      liveData: { contactEmail: "contact@textiltunis.tn", phone: "+216 71 888 200", whatsapp: "+216 20 888 200", address: "Z.I. Mégrine, Ben Arous", gouvernorat: "ben-arous", ville: "Mégrine", sectorId: "textile", languages: ["fr"] },
      ...
      profiles: {
        ...
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Ali Ben Amor"), fullName: "Ali Ben Amor", title: i18n("Directeur Commercial Export"), company: i18n("TextilTunis"), bio: i18n("20 ans dans l'industrie textile tunisienne."), email: "ali@textiltunis.tn", phone: "+216 71 888 100", whatsapp: "+216 71 888 100", website: "https://textiltunis.tn", address: "Z.I. Mégrine, Ben Arous", gpsPosition: { type: "Point", coordinates: [10.2399, 36.7773] } }, qrConfig: { style: "rounded", colorForeground: "#EC4899", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "linkedin", url: "https://linkedin.com/in/alibenamor" }] }, publishedAt: daysAgo(200), lastValidatedAt: daysAgo(200), stats: { viewsTotal: 167, views30d: 28, clicksTotal: 9 }, boosts: [{ seedId: "b-c-010-0", from: daysAgo(50), to: daysAgo(20), priceHT: 50, transactionSeedId: "t-c-010-1", viewsAdded: 89, clicksAdded: 5, status: "expired" }], sponsorings: [] },
      },
      transactions: [
        { seedId: "t-c-010-1", type: "boost", refSeedId: "b-c-010-0", profileKind: "linkup", priceHT: 50, vatRate: 0.19, status: "paid", paidAt: daysAgo(50), paymentMethod: "card", paymentReference: "MP-BST-TT-001", invoiceUrl: SAMPLE_INVOICE_DOC, invoiceNumber: "INV-2026-0020", createdAt: daysAgo(50) },
      ],
      rseReceipts: [],
    },
  ];
