...
function buildCompanies(): CompanySeedData[] {
  return [
    ...
    // c-011 — Digital Agency Tunis (NO bannerUrl — tests initials fallback)
    {
      ...
      liveData: { contactEmail: "hello@digiagency.tn", phone: "+216 71 222 400", whatsapp: "+216 20 222 400", address: "Rue du Lac Léman, Les Berges du Lac", gouvernorat: "tunis", ville: "Tunis", sectorId: "informatique", languages: ["fr"] },
      ...
      profiles: {
        ...
        traceup: { kind: "traceup", status: "incomplete", data: { channelName: i18n(""), channelDescription: i18n(""), videos: [] }, stats: { viewsTotal: 0, views30d: 0, clicksTotal: 0 }, boosts: [], sponsorings: [] },
        linkup: { kind: "linkup", status: "active", data: { contactCard: { photo: avatarUrl("Youssef Hamdi"), fullName: "Youssef Hamdi", title: i18n("CTO & Co-fondateur"), company: i18n("Digital Agency Tunis"), bio: i18n("Ingénieur full-stack passionné par l'innovation."), email: "youssef@digiagency.tn", phone: "+216 71 222 300", whatsapp: "+216 71 222 300", website: "https://digiagency.tn", address: "Rue du Lac Léman, Les Berges du Lac, Tunis", gpsPosition: { type: "Point", coordinates: [10.2250, 36.8350] } }, qrConfig: { style: "rounded", colorForeground: "#3B82F6", colorBackground: "#FFFFFF", logoOverlay: true }, socials: [{ platform: "linkedin", url: "https://linkedin.com/in/youssefhamdi" }, { platform: "instagram", url: "https://instagram.com/digiagency.tn" }] }, publishedAt: daysAgo(30), lastValidatedAt: daysAgo(30), stats: { viewsTotal: 67, views30d: 22, clicksTotal: 8 }, boosts: [], sponsorings: [] },
      },
      transactions: [], rseReceipts: [],
    },
  ];
